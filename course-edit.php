                ...
                <ul class="list-group">
                    <li class="list-group-item" style="color:#176B87;">
                        <a href="course.php" class="btn text-danger">
                            <i class="fas fa-grip-vertical" style="color:#176B87;"></i> COURSES</a>
                    </li>
                    <li class="list-group-item" style="color:#176B87;">
                        <a href="questions.php" class="btn">
                            <i class="fas fa-boxes" style="color:#176B87;"></i> QUESTIONS</a>
                    </li>
                    <li class="list-group-item" style="color:#176B87;">
                        <a href="new-question.php" class="btn">
                            <i class="fas fa-plus" style="color:#176B87;"></i> ADD QUESTION</a>
                    </li>
                </ul>
            </div>
